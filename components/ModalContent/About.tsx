...
function AboutModal() {
  return (
    <div className="relative z-40 text-lg cursor-default overflow-y-scroll h-[70vh] p-6 space-y-5 text-black">
      ...
      <p>
        Quando non scrivo, <b>insegno a farlo per il web</b>. Lo faccio con la
        Camera di Commercio di Genova, ITS e altri enti di formazione. Insegnare
        alle persone adulte è buffo e istruttivo: le nostre convinzioni son ben
        radicate ed è divertente vedere quanto e come si possa smuoverle.
      </p>
      <p>
        Mi capita di finire <b>nelle scuole a parlare di linguaggio aperto</b> e
        del mio bislacco mestiere; non parlo mai di prescrizioni ma alleno a
        farsi un po` di domande, dialogando tra pari. Vi dirò, pare funzionare.
      ...
      <p>
        ...
        sensazione di inciampare in un vecchio amore. <b>Vivo a Genova</b> e
        recupero con le Instagram stories tutte le parole che ci sono sui suoi
      ...
      <div className="space-y-2">
        ...
        <p>
          - Studio il <b>tono di voce</b> di aziende e istituzioni che vogliono
          parlare chiaro e riconoscibile
        </p>
        <p>
        ...
        <p>
          - Faccio <b>formazione</b> su comunicazione e linguaggio (amo farlo
