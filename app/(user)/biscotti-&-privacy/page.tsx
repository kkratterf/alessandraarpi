        ...
        <div className="relative z-40 text-lg cursor-default space-y-4 text-black">
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              , con sede a Genova, in via Ausonia 2, e sono titolare del
              trattamento dei dati che vengono raccolti dal mio sito web{' '}
              <a
          ...
          <div className="space-y-2">
            ...
            <p>
              ...
              alcune informazioni e trattare alcuni dati. Ecco quali. Tratto i
              dati di contatto: sono quelli che tu mi fornisci compilando il
              form dedicato ai contatti, iscrivendoti alla newsletter,
              scaricando le guide che ti metto a disposizione, iscrivendoti a
              corsi e webinar, prenotando consulenze online, o facendo
              operazioni analoghe. Si tratta di dati come nome, cognome e
              e-mail che mi permettono di rispondere alle tue richieste di
              informazioni o di inoltrarti la newsletter periodica Caramelle,
              appunto. In mancanza di questi dati non posso rispondere alle tue
              domande, inserirti nella mia mailing list e darti i prodotti e i
              servizi che mi hai richiesto. Il canale principale grazie al quale
              raccolgo questi dati è la mia mailing list. Si tratta dei contatti
              interessati a ricevere periodicamente i contenuti, le storie e le
              “caramelle” che voglio condividere perché penso siano utili e
              coinvolgenti. Scrivere contenuti interessanti, però, non basta.
              Per far funzionare al meglio la mailng list occorre uno strumento
              che gestisca da un lato i contenuti da mandare e dall’altro le
              persone interessate a riceverli. In questo mi aiuta Mailchimp: ti
              spiego meglio come funziona passo passo. Nel momento in cui decidi
              di iscriverti alla mia newsletter, Caramelle, ti chiedo di
              indicarmi i tuoi dati di contatto che mi servono per
              personalizzare la comunicazione. Fatto questo, Mailchimp inoltra
              al mio account i tuoi dati, la data e l’ora di registrazione e il
              metodo che hai usato per iscriverti, insieme al tuo consenso ad
              usare la tua e-mail per la pubblicità su Facebook (di cui ti dico
              più avanti). E poi? A questo punto i tuoi dati di contatto sono
              inseriti nella mailing list che è la mia cartina tornasole dei
              contatti interessati a ciò che scrivo. Così posso inoltrarti
              periodicamente pochi contenuti scelti con cura. Avere a
              disposizione il tuo indirizzo mail mi consente di bussare alla tua
              casella di posta ogni volta che ho una novità per te, una storia
          ...
          <div className="space-y-2">
            ...
            <p>
              Sul mio server Mailchimp conserva tue informazioni come nome,
              cognome, indirizzo e-mail e indirizzo IP. Queste informazioni sono
              conservate da Mailchimp sui suoi server, ma per sicurezza anch’io
              ne conservo un backup giornaliero in formato Excel che tengo in un
              luogo sicuro, al riparo da occhi indiscreti. Per completezza, ecco
              la privacy policy di Mailchimp: Chi può accedere a questi dati? In
              questo momento solo io, Alessandra Arpi, ho accesso al mio account
              Mailchimp, per questo nessun altro può vedere le informazioni che
              lì sono contenute. Come cancellare questi dati? Se non vuoi più
              ricevere la mia newsletter, sei libero di cancellarti in ogni
              momento. Per farlo, ti è sufficiente cliccare sul footer che trovi
              in ogni mail. Se invece vuoi la cancellazione di tutti i dati dal
              server di Mailchimp, scrivimi sempre a: ciao@alessandraarpi.it
            </p>
          </div>
          <div className="space-y-2">
            <h6 className="text-xl font-bold">
          ...
          <div className="space-y-2">
            ...
            <p>
              Come ti dicevo poco sopra, il mio sito si avvale di Google
              Analytics per raccogliere le informazioni utili a capire quali
              contenuti funzionano e quali no. Anche per l’utilizzo di questo
              tipo di cookie è necessario il tuo consenso esplicito. Se dopo
              aver preso visione dell’informativa breve contenuta nell’apposito
              banner, decidi di proseguire la navigazione e di usufruire dei
              servizi di terze parti che comportano l’installazione di Cookie,
              hai liberamente manifestato il tuo consenso all’uso di questi
              cookie. Ecco la cookie policy di Google Analytics. Nel caso
              volessi disabilitare l’azione di Google Analytics, puoi farlo
              attraverso l’opt-out.  Come puoi acconsentire all’uso dei cookie
              da parte del mio sito web?  Se, appena atterrato sul sito, prendi
              visione dell’informativa breve nel banner e decidi di proseguire
              la navigazione, accettando espressamente di usufruire dei servizi
              di terze parti che comportano l’installazione di Cookie, questo
              rappresenta il tuo consenso manifestato in modo informato e
              consapevole. Eliminazione o disattivazione dei cookie –
              Opt-out Eccoci finalmente giunti alla sezione dedicata al tuo
              diritto di opt-out. Come ti dicevo poco più sopra, i cookie
              possono essere disattivati, fatta eccezione per quelli tecnici.
              Puoi evitare l’installazione dei Cookie mantenendo il relativo
              banner visibile o attraverso le apposite funzioni disponibili sul
              tuo browser. Di seguito ecco i link che spiegano come disabilitare
              i cookie per i browser più diffusi: Internet Explorer Google
              Chrome Mozilla Firefox  Apple Safari Ti informo che la
              disabilitazione dei cookie tramite le impostazioni del browser
              comporterà l’impossibilità di fruire di alcuni servizi del sito.
              3. Perché tratto i tuoi dati? Terminata la descrizione dei dati
              che tratto, ora voglio spiegarti perché tratto i tuoi dati, come
              lo faccio e su quale base giuridica. Tratto i tuoi dati in modo
              lecito, corretto e trasparente, proprio come richiesto dalla
              normativa (art. 13 GDPR). Raccolgo i tuoi dati con finalità
              precise e ogni volta che lo faccio, lo faccio sulla scorta di una
              base giuridica ben definita. Ma andiamo con ordine, e vediamo le
              finalità del trattamento. Raccolgo i tuoi dati per: 1) ottemperare
              agli obblighi di legge cui sono soggetta In questo caso la base
              giuridica del trattamento è proprio la legge che me lo impone. 2)
              ...
              mancata comunicazione di uno o più dati mi impedisce di erogare
              questo servizio. 3) poter rispondere a ogni tua richiesta di
              informazioni inoltrata attraverso il form contatti, via e-mail 
              Anche questo tipo di trattamento è facoltativo e la sua base
              giuridica poggia sul tuo consenso liberamente espresso. Per questo
              la mancata comunicazione di uno o più dati mi impedisce di
              risponderti o mandarti ciò che ti serve. 4) tenerti aggiornat3 sui
              contenuti che realizzo, anche tramite l’inoltro di newsletter
              Ancora una volta, il trattamento dei tuoi dati è facoltativo e la
              sua base giuridica è costituita dal tuo consenso liberamente
              espresso. Per questo la mancata comunicazione di uno o più dati
              non mi consente di inviarti i miei contenuti. 5) per darti la
              ...
              consentire al mio sito di funzionare al meglio, attraverso
              l’analisi statistica del traffico e del comportamento degli
              utenti Anche qui, il trattamento dei tuoi dati è facoltativo e la
              sua base giuridica è il tuo consenso. La mancata comunicazione di
              questi dati non mi consente di capire cosa funziona e cosa no, ma
              se preferisci non dare il consenso, va bene lo stesso.
            </p>
          </div>
          <div className="space-y-2">
            <h6 className="text-xl font-bold">
